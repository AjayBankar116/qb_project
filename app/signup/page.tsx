...
export default function SignUp({
  ...
  return (
    <div className="overflow-y-hidden grid grid-cols-1 justify-items-center gap-8 ">
      {/* header section  */}
      <header className="w-full h-[4rem] grid grid-cols-1 justify-items-center  left-0">
      ...
      <section className="grid grid-cols-1 justify-items-center">
        <div className="grid grid-cols-1 justify-items-center h-[21.25rem]   ">
          <div className="w-[17.6875rem] h-[2.5rem]">
            <p className="font-semibold text-[1.875rem]">Create new account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className=" mt-5 flex flex-col gap-8">
            <div>
      ...
      {/* bottom navigation  */}
      <div className="w-full h-[8.75rem] grid grid-cols-1 fixed left-0 bottom-0 place-items-center">
        <div className="w-[20.625rem] h-[2.25rem] fixed bottom-28 grid grid-cols-1 place-items-center">
          <p className="text-[0.75rem] font-medium text-center">

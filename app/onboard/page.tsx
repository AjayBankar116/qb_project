...
const handleSubmit = async (e: any) => {
  ...
  // If sign-up is successful, you can redirect to the desired page
  redirect("/");
};
...
const Onboard = () => {
  ...
  return (
    <div className="grid grid-cols-1 justify-items-center ">
      {/* header section  */}
      <header className="overflow-y-hidden grid grid-cols-1 justify-items-center gap-8 ">
        <div className="w-[14.97rem] h-[6.5625rem] fixed top-0  flex flex-col justify-center items-center">
          <div className="w-[14.9375rem] h-[4rem] flex justify-center items-center">
            <div className="w-[13.125rem] h-[2.625rem]">
              <svg
                width="211"
                height="43"
                viewBox="0 0 211 43"
          ...
          <div className="w-[14.9375rem] h-[2.625rem]">
            <p
              className={`text-[1.5rem] leading-5 text-center font-bold text-gray-600 ${caveat.className}`}
            >
              Bharat's best quotation management app
            </p>
          </div>
        </div>
      </header>
      ...
      {/* body section  */}
      <Carousel className="w-full grid grid-cols-1 justify-center items-center rounded-3xl fixed top-40">
        <CarouselContent className="px-4">
          <CarouselItem className="w-[18.75rem] h-[18.75rem] text-center bg-green-200 rounded-3xl border-2">
            One
          </CarouselItem>
          <CarouselItem className="w-[18.75rem] h-[18.75rem] text-center bg-green-400 rounded-3xl">
            Two
          </CarouselItem>
          <CarouselItem className="w-[18.75rem] h-[18.75rem] text-center bg-green-600 rounded-3xl">
            Three
          </CarouselItem>
        </CarouselContent>
      ...
      {/* bottom navigation  */}
      <nav className="flex flex-col justify-center items-center gap-4 fixed bottom-0">
        <form
          onSubmit={handleSubmit}
          className="   w-full  flex flex-col justify-center items-center  fixed bottom-0"
        >
          ...
          <div className="w-full h-[8.75rem] flex flex-col justify-center items-center">
            <Button
              type="submit"
              className="bg-green-600 hover:bg-green-700 text-white font-medium py-[0.125rem] px-[0.25rem] rounded-full w-[20.625rem]"
            >
              Login
            </Button>
          </div>

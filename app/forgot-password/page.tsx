  ...
  return (
    <div className="overflow-y-hidden h-full flex flex-col justify-center items-center gap-8 ">
      ...
      <section className="flex justify-center items-center ">
        <div className="flex flex-col justify-center items-center w-[330px] gap-8  ">
            ...
            <div>
              <div className="relative ">
                ...
                <input
                  ...
                  className="block px-2.5 pb-3 pt-4 w-[330px] h-[52px] font-normal  text-[14px] text-gray-700 leading-6 bg-transparent rounded-xl border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600  dark:focus:border-green-500 focus:outline-none focus:border-2 focus:ring-0 focus:border-green-600 peer pl-10"
                  placeholder=" "
                />
                <label
                  for="mobile_number"

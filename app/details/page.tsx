...
export default function DetailsPage({
  ...
  return (
    <div className="overflow-y-hidden grid grid-cols-1 justify-items-center gap-8">
      {/* header section  */}
      ...
      <section className=" grid grid-cols-1 justify-items-center ">
        <div className="  grid grid-cols-1 justify-items-center gap-8 w-[20.625rem] h-[20.375rem]">
          <div className=" w-full h-[2.125rem]">
            <p className="font-normal text-[2rem]  text-center text-primary">
            Create new account
            </p>
          </div>
            ...
            <div>
              <div className="relative ">
                <input
                  ...
                  className="block px-2.5 pb-3 pt-4 w-[20.625rem] h-[3.25rem] font-normal  text-[0.875rem] text-gray-700 leading-6 bg-transparent rounded-xl border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:border-2 focus:outline-none focus:ring-0 focus:border-green-600 peer "
                  placeholder=" "
                />
                <label
                  for="company_name"
                  class="absolute text-sm text-green-600 dark:text-green-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-base_light dark:bg-gray-900 px-2 peer-focus:px-2 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 start-1 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto"
                >
                  Company Name
                </label>
              </div>
            ...
            <div>
              <div className="relative ">
                <input
                  ...
                  type="text"
                  id="your_name"
                  aria-describedby="your_name_help"
                  className="block px-2.5 pb-3 pt-4 w-[20.625rem] h-[3.25rem] font-normal  text-[0.875rem] text-gray-700 leading-6 bg-transparent rounded-xl border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:border-2 focus:outline-none focus:ring-0 focus:border-green-600 peer "
                  placeholder=" "
                />
                <label
